...
console.log("Filtering address: " + wallet.address);
console.log("\n");
...
(async function() {
  let transferEvent = new Promise((resolve, reject) => {
    ...
    // filtering addresses on event
    let filterFromMe = contract.filters.Transfer(wallet.address, null);
    let filterToMe = contract.filters.Transfer(null, wallet.address);
    let handleEvent = function(from, to) {
      console.log("Filtered From  : " + from);
      console.log("Filtered To    : " + to);
      console.log("\n");
    };
